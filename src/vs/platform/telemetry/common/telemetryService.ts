...
Raccoon separately records basic usage like the number of messages people are sending. If you'd like to disable Raccoon metrics, you may do so in Raccoon's Settings.
`;
