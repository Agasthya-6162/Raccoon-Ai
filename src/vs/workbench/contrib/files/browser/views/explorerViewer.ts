...
export class FilesRenderer implements ICompressibleTreeRenderer<ExplorerItem, FuzzyScore, IFileTemplateData>, IListAccessibilityProvider<ExplorerItem>, IDisposable {
	...
	// const raccoonButtonsContainer = DOM.append(container, DOM.$('div'));
	// raccoonButtonsContainer.style.position = 'absolute'
	// raccoonButtonsContainer.style.top = '0'
	// raccoonButtonsContainer.style.right = '0'
	// // const raccoonButtons = DOM.append(raccoonButtonsContainer, DOM.$('span'));
	// // raccoonButtons.textContent = 'raccoonbuttons'
	// // raccoonButtons.addEventListener('click', () => {
	// // 	console.log('ON CLICK', templateData.currentContext?.children)
	// // })
	// const raccoonLabels = this.labels.create(raccoonButtonsContainer, { supportHighlights: false, supportIcons: false, });
	// raccoonLabels.element.textContent = 'hi333'
