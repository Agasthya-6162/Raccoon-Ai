...
import { raccoon_OPEN_SETTINGS_ACTION_ID } from '../../raccoon/browser/raccoonSettingsPane.js';
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		...
		title: nls.localize({ key: 'openraccoon', comment: ['&& denotes a mnemonic'] }, "&&Open Raccoon Settings"),
	},
	order: 1
});
