...
registerColor('raccoon.greenBG', configOfBG(acceptBG), '', true);
registerColor('raccoon.redBG', configOfBG(rejectBG), '', true);
registerColor('raccoon.sweepBG', configOfBG(sweepBG), '', true);
registerColor('raccoon.highlightBG', configOfBG(highlightBG), '', true);
registerColor('raccoon.sweepIdxBG', configOfBG(sweepIdxBG), '', true);
