...
type raccoonModelType = {
	model: ITextModel | null;
	editorModel: IResolvedTextEditorModel | null;
};

export interface IRaccoonModelService {
	readonly _serviceBrand: undefined;
	initializeModel(uri: URI): Promise<void>;
	getModel(uri: URI): raccoonModelType;
	getModelFromFsPath(fsPath: string): raccoonModelType;
	getModelSafe(uri: URI): Promise<raccoonModelType>;
	saveModel(uri: URI): Promise<void>;

}

export const IRaccoonModelService = createDecorator<IRaccoonModelService>('raccoonraccoonModelService');

class RaccoonModelService extends Disposable implements IRaccoonModelService {
	_serviceBrand: undefined;
	static readonly ID = 'raccoonraccoonModelService';
	...
	getModelSafe = async (uri: URI): Promise<raccoonModelType> => {
...
registerSingleton(IRaccoonModelService, RaccoonModelService, InstantiationType.Eager);
