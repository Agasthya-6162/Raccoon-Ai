...
class ConvertContribWorkbenchContribution extends Disposable implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.raccoon.convertcontrib'
	...
	constructor(
		...
		const initializeURI = (uri: URI) => {
			...
			const raccoonRulesURI = URI.joinPath(uri, '.raccoonrules')
			this.raccoonModelService.initializeModel(raccoonRulesURI)
		}
