	...
	theme: {
		extend: {
			typography: theme => ({
				DEFAULT: {
					css: {
						'--tw-prose-body': 'var(--raccoon-fg-1)',
						'--tw-prose-headings': 'var(--raccoon-fg-1)',
						'--tw-prose-lead': 'var(--raccoon-fg-2)',
						'--tw-prose-links': 'var(--raccoon-link-color)',
						'--tw-prose-bold': 'var(--raccoon-fg-1)',
						'--tw-prose-counters': 'var(--raccoon-fg-3)',
						'--tw-prose-bullets': 'var(--raccoon-fg-3)',
						'--tw-prose-hr': 'var(--raccoon-border-4)',
						'--tw-prose-quotes': 'var(--raccoon-fg-1)',
						'--tw-prose-quote-borders': 'var(--raccoon-border-2)',
						'--tw-prose-captions': 'var(--raccoon-fg-3)',
						'--tw-prose-code': 'var(--raccoon-fg-0)',
						'--tw-prose-pre-code': 'var(--raccoon-fg-0)',
						'--tw-prose-pre-bg': 'var(--raccoon-bg-1)',
						'--tw-prose-th-borders': 'var(--raccoon-border-4)',
						'--tw-prose-td-borders': 'var(--raccoon-border-4)',
					},
				},
			}),
			fontSize: {
			...
			colors: {
				'raccoon-bg-1': 'var(--raccoon-bg-1)',
				'raccoon-bg-1-alt': 'var(--raccoon-bg-1-alt)',
				'raccoon-bg-2': 'var(--raccoon-bg-2)',
				'raccoon-bg-2-alt': 'var(--raccoon-bg-2-alt)',
				'raccoon-bg-2-hover': 'var(--raccoon-bg-2-hover)',
				'raccoon-bg-3': 'var(--raccoon-bg-3)',


				'raccoon-fg-0': 'var(--raccoon-fg-0)',
				'raccoon-fg-1': 'var(--raccoon-fg-1)',
				'raccoon-fg-2': 'var(--raccoon-fg-2)',
				'raccoon-fg-3': 'var(--raccoon-fg-3)',
				// 'raccoon-fg-4': 'var(--vscode-tab-inactiveForeground)',
				'raccoon-fg-4': 'var(--raccoon-fg-4)',

				'raccoon-warning': 'var(--raccoon-warning)',

				'raccoon-border-1': 'var(--raccoon-border-1)',
				'raccoon-border-2': 'var(--raccoon-border-2)',
				'raccoon-border-3': 'var(--raccoon-border-3)',
				'raccoon-border-4': 'var(--raccoon-border-4)',

				'raccoon-ring-color': 'var(--raccoon-ring-color)',
				'raccoon-link-color': 'var(--raccoon-link-color)',
