...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/raccoon/common/raccoonSettingsTypes.js';
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js';
import { raccoonSettingsState } from '../../../../../../../workbench/contrib/raccoon/common/raccoonSettingsService.js';
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js';
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/raccoon/common/refreshModelService.js';
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/raccoon/common/refreshModelService.js';
import { IRaccoonSettingsService } from '../../../../../../../workbench/contrib/raccoon/common/raccoonSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/raccoon/browser/extensionTransferService.js';
...
let settingsState: raccoonSettingsState;
const settingsStateListeners: Set<(s: raccoonSettingsState) => void> = new Set();
...
export const _registerServices = (accessor: ServicesAccessor) => {
  ...
  const stateServices = {
    ...
    settingsStateService: accessor.get(IRaccoonSettingsService),
    refreshModelService: accessor.get(IRefreshModelService),
    themeService: accessor.get(IThemeService),
    editCodeService: accessor.get(IEditCodeService),
    raccoonCommandBarService: accessor.get(IRaccoonCommandBarService),
    modelService: accessor.get(IModelService),
    mcpService: accessor.get(IMCPService)
  };

  const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, raccoonCommandBarService, modelService, mcpService } = stateServices;
  ...
  disposables.push(
    raccoonCommandBarService.onDidChangeState(({ uri }) => {
      commandBarURIStateListeners.forEach((l) => l(uri));
    })
  );

  disposables.push(
    raccoonCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
  const reactAccessor = {
    ...
    IRaccoonSettingsService: accessor.get(IRaccoonSettingsService),
    ...
    IRaccoonModelService: accessor.get(IRaccoonModelService),
    IWorkspaceContextService: accessor.get(IWorkspaceContextService),

    IRaccoonCommandBarService: accessor.get(IRaccoonCommandBarService),
