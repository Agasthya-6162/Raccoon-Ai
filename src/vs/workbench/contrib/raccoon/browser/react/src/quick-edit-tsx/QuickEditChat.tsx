...
import { TextAreaFns, RaccoonInputBox2 } from '../util/inputs.js';
import { QuickEditPropsType } from '../../../quickEditActions.js';
import { ButtonStop, ButtonSubmit, IconX, RaccoonChatArea } from '../sidebar-tsx/SidebarChat.js';
import { raccoon_CTRL_K_ACTION_ID } from '../../../actionIDs.js';
import { useRefState } from '../util/helpers.js';
import { isFeatureNameDisabled } from '../../../../../../../workbench/contrib/raccoon/common/raccoonSettingsTypes.js';
...
export const QuickEditChat = ({
  ...
  const loadingIcon = <div
    className="codicon codicon-loading codicon-modifier-spin codicon-no-default-spin raccoon-text-raccoon-fg-3" />;
  ...
  const keybindingString = accessor.get('IKeybindingService').lookupKeybinding(raccoon_CTRL_K_ACTION_ID)?.getLabel();

  const chatAreaRef = useRef<HTMLDivElement | null>(null);
  return <div ref={sizerRef} style={{ maxWidth: 450 }} className={`raccoon-py-2 raccoon-w-full`}>
		<RaccoonChatArea
      featureName='Ctrl+K'
      divRef={chatAreaRef}
      onSubmit={onSubmit}
