...
// The extension this was called from is here - https://github.com/DevFlex-AI/Raccoon/blob/autocomplete/extensions/raccoon/src/extension/extension.ts
...
export class AutocompleteService extends Disposable implements IAutocompleteService {
	...
	static readonly ID = 'raccoon.autocompleteService'
