...
import { Diff, DiffArea, raccoonFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getraccoonFileSnapshot(uri: URI): raccoonFileSnapshot;
	restoreraccoonFileSnapshot(uri: URI, snapshot: raccoonFileSnapshot): void;
}
