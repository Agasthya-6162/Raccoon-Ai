...
export class ToolsService implements IToolsService {
	...
	constructor(
		...
		@IRaccoonModelService raccoonModelService: IRaccoonModelService,
		@IEditCodeService editCodeService: IEditCodeService,
		@ITerminalToolService private readonly terminalToolService: ITerminalToolService,
		@IRaccoonCommandBarService private readonly commandBarService: IRaccoonCommandBarService,
		...
		this.callTool = {
			read_file: async ({ uri, startLine, endLine, pageNumber }) => {
				await raccoonModelService.initializeModel(uri)
				const { model } = await raccoonModelService.getModelSafe(uri)
		...
		this.stringOfResult = {
			...
			search_in_file: (params, result) => {
				const { model } = raccoonModelService.getModel(params.uri)
			...
			edit_file: (params, result) => {
				const lintErrsString = (
					this.raccoonSettingsService.state.globalSettings.includeToolLintErrors ?
