...
The file that starts with `1.` is diffed against the file that starts with `2.`. Use `tst` instead of `ts` to araccoon compiler/linter errors for typescript diff files.
