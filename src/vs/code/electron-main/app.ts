...
import { IMetricsService } from '../../workbench/contrib/raccoon/common/metricsService.js';
// eslint-disable-next-line
import { IRaccoonUpdateService } from '../../workbench/contrib/raccoon/common/raccoonUpdateService.js';
// eslint-disable-next-line
import { MetricsMainService } from '../../workbench/contrib/raccoon/electron-main/metricsMainService.js';
// eslint-disable-next-line
import { RaccoonMainUpdateService } from '../../workbench/contrib/raccoon/electron-main/raccoonUpdateMainService.js';
// eslint-disable-next-line
import { LLMMessageChannel } from '../../workbench/contrib/raccoon/electron-main/sendLLMMessageChannel.js';
// eslint-disable-next-line
import { RaccoonSCMService } from '../../workbench/contrib/raccoon/electron-main/raccoonSCMMainService.js';
// eslint-disable-next-line
import { IRaccoonSCMService } from '../../workbench/contrib/raccoon/common/raccoonSCMTypes.js';
// eslint-disable-next-line
import { MCPChannel } from '../../workbench/contrib/raccoon/electron-main/mcpChannel.js';
/**
...
export class CodeApplication extends Disposable {
	...
	private async initServices(machineId: string, sqmId: string, devDeviceId: string, sharedProcessReady: Promise<MessagePortClient>): Promise<IInstantiationService> {
		...
		services.set(IRaccoonUpdateService, new SyncDescriptor(RaccoonMainUpdateService, undefined, false));
		services.set(IRaccoonSCMService, new SyncDescriptor(RaccoonSCMService, undefined, false));
	...
	private initChannels(accessor: ServicesAccessor, mainProcessElectronServer: ElectronIPCServer, sharedProcessClient: Promise<MessagePortClient>): void {
		...
		mainProcessElectronServer.registerChannel('raccoon-channel-metrics', metricsChannel);

		const raccoonUpdatesChannel = ProxyChannel.fromService(accessor.get(IRaccoonUpdateService), disposables);
		mainProcessElectronServer.registerChannel('raccoon-channel-update', raccoonUpdatesChannel);

		const sendLLMMessageChannel = new LLMMessageChannel(accessor.get(IMetricsService));
		mainProcessElectronServer.registerChannel('raccoon-channel-llmMessage', sendLLMMessageChannel);

		// void added this
		const raccoonSCMChannel = ProxyChannel.fromService(accessor.get(IRaccoonSCMService), disposables);
		mainProcessElectronServer.registerChannel('raccoon-channel-scm', raccoonSCMChannel);

		// void added this
		const mcpChannel = new MCPChannel();
		mainProcessElectronServer.registerChannel('raccoon-channel-mcp', mcpChannel);
