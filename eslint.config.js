...
export default tseslint.config(
	...
	// All files (JS and TS)
	{
		...
		rules: {
			...
			'local/code-no-dangerous-type-assertions': 'off', // Raccoon warn -> off
			...
			// Raccoon - this should only apply to workbench/raccoon/
			// 'header/header': [
			// 	2,
			// 	'block',
			// 	[
	...
	// TS
	{
		...
		rules: {
			'@stylistic/ts/semi': 'off', // <-- Raccoon
			'@stylistic/ts/member-delimiter-style': 'off', // <-- Raccoon
			...
			'jsdoc/no-types': 'warn',
			'local/code-no-static-self-ref': 'off' // <-- Raccoon
		}
	},
	// vscode TS
	{
